...
{
  public sealed class CreateStandardWaterInitialisationData : ICreate, ICreateStandard<ScoreboardData.rootmap>
  {
...
<rootmap
    ...
    <initialisation>
        <!-- Soil W for modelling lupin root growth in pots, simulations in sandy soil -->
