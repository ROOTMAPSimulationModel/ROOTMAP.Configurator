...
{
  public class RendererCharacteristicColourInfoViewModel : BaseViewModel, ICharacteristicColourInfoViewModel
  {
    private readonly Schema.Renderer.CharacteristicColourInfo _dataModel;
    public RendererCharacteristicColourInfoViewModel(Schema.Renderer.CharacteristicColourInfo dataModel)
    {
